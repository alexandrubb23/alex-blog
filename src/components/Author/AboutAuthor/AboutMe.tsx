  ...
  return (
    <Container id="content-container">
      ...
      >
        ...
        <AnimationScroll mx="auto" offset={0}>
          <Box textAlign="center">
            <AuthorAvatar />
          </Box>
        </AnimationScroll>
          ...
          <GridItem>
            ...
            >
              <Box>
                ...
                various projects for esteemed companies like Vodafone and
                Adidas, where I&apos;ve gained a lot of experience (expertise in
                domains such as gaming, payment systems, communication, and
                more.)
              </Box>
        ...
        <Box maxW="100%" mx="auto" textAlign="center" px={{ base: 4, md: 0 }}>
          <Heading as="h2" size={{ base: "md", md: "lg" }} mb={2}>
            <AnimationScroll offset={0}>
              ...
              complex problems and drive innovation. I take pride in my ability
              to adapt to different technologies and thrive in dynamic
              environments.
            </AnimationScroll>
          </Heading>
        </Box>
          ...
          <GridItem>
            ...
            >
              <Heading as="h3">
                ...
                Jujutsu, a martial art that emphasizes balance, control, and
                inner harmony.
              </Heading>
              <Box>
                When I&apos;m not writing software, I dedicate time to training
                in 
                <strong>Hakko Denshin Ryu Jujutsu</strong>, a traditional
                Japanese martial art. I&apos;m honored to hold two dan ranks,
                and I proudly wear them in recognition of the discipline and
                growth this journey has brought me.
              </Box>
              <Box>
                You can see a photo of me with{" "}
                <strong>Soke Antonio Garcia</strong> wearing my two dans — a
                symbol not of mastery, but of continuous learning and
                dedication.
              </Box>
              <Box>
                The martial art I practice,{" "}
                <strong>Hakko Denshin Ryu Jujutsu</strong>, translates to{" "}
                <strong>Eight Directions Soft Technique</strong>, symbolizing
                the fluidity and adaptability I aim to embody—both in my martial
                arts journey and my work as a software engineer.
              </Box>
              <Box>
                Our dojo is named <strong>Senshinkan</strong>, meaning{" "}
                <strong>The place where you purify your mind and heart,</strong>{" "}
                a guiding principle in both practice and daily life.
              </Box>
              <Box maxWidth="fit-content">
                <SolidAnimatedButton
                  onClick={() =>
          ...
          <GridItem>
            ...
            >
              ...
              <Box>
                ...
                classic arcade gaming. I&apos;ve built an impressive collection
                of consoles and games over the years—including legendary systems
                like the Sega Genesis, Sony PlayStation (PSX), Nintendo
                Entertainment System (NES), Super Nintendo (SNES), and the
                iconic Neo Geo.
              </Box>
              <Box>
                🕹️ I also own full-sized arcade cabinets, bringing the authentic
                arcade experience right into my home. For me, it&apos;s not just
                nostalgia—it&apos;s about preserving a piece of gaming history
                and celebrating the creativity, design, and joy these systems
                continue to inspire.
              </Box>
            </AnimationScroll>
          </GridItem>
